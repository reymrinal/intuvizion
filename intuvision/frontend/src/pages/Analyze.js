      ...
      <div style={{ marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          ...
          <p style={{ color: '#64748b', margin: '4px 0 0', fontSize: 13 }}>
            Select a video + rules, hit Run. GPT-4o Vision analyzes every frame.
          </p>
        </div>
        <button onClick={fetchData} title="Refresh videos & rules"
          style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: 8, padding: '8px 12px', color: '#94a3b8', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6, fontSize: 13 }}>
